              ...
              "ModelCRUD": {
                ...
                "DataRow": {
                  "field": [
                    ...
                    {"@column": "Name", "val": encodedName},
                    {"@column": "AD_Client_ID", "val": clientId},
                    ...
                    // },
                    {"@column": "EMail", "val": customer['email']}
                  ]
                }
              }
            },
              ...
              "ModelCRUD": {
                ...
                "DataRow": {
                  "field": [
                    ...
                    {"@column": "RegionName", "val": customer['region']},
                    {"@column": "City", "val": customer['city']},
                    {"@column": "Address1", "val": customer['address']},
                    {"@column": "Postal", "val": customer['code_postal']}
                  ]
                }
              }
            },
              ...
              "ModelCRUD": {
                ...
                "DataRow": {
                  "field": [
                    ...
                    {"@column": "IsShipTo", "val": "Y"},
                    {"@column": "IsBillTo", "val": "Y"},
                    {"@column": "Phone", "val": customer['phone']},
                    {
                    ...
                    {"@column": "IsRemitTo", "val": "Y"},
                    {"@column": "IsPayFrom", "val": "Y"}
                  ]
                }
              }
            }
