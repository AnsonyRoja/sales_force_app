...
import 'package:sales_force/presentation/clients/helpers/save_client_to_database.dart';
...
//List
  ...
  final List<Map<String, dynamic>> _statesVnz = [];
  final List<Map<String, dynamic>> _listPrice = [];
  ...
  int _selectedStatesVnz = 0;
  int _selectedMpriceList = 0;
// Text
  ...
  loadList() async {
    ...
    List<Map<String, dynamic>> getStatesVn = await getStatesVnz();
    ...
    print('Esto es el uniqueListPrice $uniqueListPrice');
    print('Esta es la respuesta de getstates $getStatesVn');
    ...
    _listPrice.add({
      'm_pricelist_id': 0,
      'price_list_name': 'Selecciona una Lista de Precio'
    });
    _statesVnz.add({'c_region_id': 0, 'name': 'Selecciona un Estado'});
    ...
    setState(() {
      _listPrice.addAll(uniqueListPrice);
      _statesVnz.addAll(getStatesVn);
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'Por favor ingresa un RIF/CI Valido';
                          }
                          return null;
                        },
                      ),
                    ...
                    CustomDropdownButtonFormField(
                      identifier: 'priceListSelect',
                      selectedIndex: _selectedMpriceList,
                      dataList: _listPrice,
                      text: _mPriceListText,
                      onSelected: (newValue, selected) {
                        setState(() {
                          _selectedMpriceList = newValue ?? 0;
                          _mPriceListText = selected;
                        });
                      },
                    ),
                    ...
                    CustomDropdownButtonFormField(
                      identifier: 'selectState',
                      selectedIndex: _selectedStatesVnz,
                      dataList: _statesVnz,
                      text: _countryText,
                      onSelected: (newValue, stateText) {
                        setState(() {
                          _selectedStatesVnz = newValue ?? 0;

                          _strStates = stateText;
                        });

                        print('selected region $_selectedStatesVnz');
                      },
                    ),
  ...
  void _saveProduct() async {
    ...
    int selectedStateId = _selectedStatesVnz;
    ...
    print('Este es el valor del estado $selectedStateId');
    ...
    Customer client = Customer(
        ...
        mPriceListId: _selectedMpriceList);
