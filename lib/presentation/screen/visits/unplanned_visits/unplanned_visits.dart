...
import 'package:sales_force/presentation/screen/visits/unplanned_visits/add_unplanned_visits.dart';
import 'package:url_launcher/url_launcher_string.dart';
import 'package:sizer/sizer.dart';

class UnplannedVisits extends StatefulWidget {
  const UnplannedVisits({super.key});

  @override
  State<UnplannedVisits> createState() => _UnplannedVisitsState();
}

class _UnplannedVisitsState extends State<UnplannedVisits> {
  ...
  @override
  void dispose() {
    fechaIdempiereControllerEnd.dispose();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: Stack(
          children: [
            const AppBarSample(label: "Visitas No Planificadas"),
            Positioned(
              left: 16,
              right: 16,
              top: 90,
                      ...
                      return Column(
                        children: [
                          Container(
                            ...
                            height: visit['end_date'] != '' ? 38.3.h : 35.7.h,
                            constraints:
                                BoxConstraints(minHeight: screenHight * 0.1),
                                            ...
                                            backgroundColor:
                                                WidgetStatePropertyAll(
                                                    visit['state'] == 'Visits'
                                                        ? Colors.green
                                                        : Colors.grey)),
                                        onPressed: visit['state'] == 'No Visits'
                                            ? () {
                                                if (visit['state'] ==
                                                    'No Visits') {
                                                  showDialog(
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const AddUnplannedVisits()),
                ),
                child: Image.asset(
