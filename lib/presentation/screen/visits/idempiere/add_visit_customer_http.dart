...
addVisitCustomerIdempiere(visit, endDate) async {
  ...
  final uri = Uri.parse(
      '${map['URL']}ADInterface/services/rest/model_adservice/create_data');
  ...
  final requestBody = {
    "ModelCRUDRequest": {
      "ModelCRUD": {
        ...
        "DataRow": {
          "field": [
            {"@column": "C_BPartner_ID", "val": visit['c_bpartner_id']},
            {"@column": "C_SalesRegion_ID", "val": visit['c_sales_region_id']},
            {"@column": "Coordinates", "val": visit['coordinates'].toString()},
            {"@column": "Description", "val": visit['description']},
            {"@column": "EndDate", "val": endDate},
            {"@column": "SalesRep_ID", "val": visit['sales_rep_id']},
            {"@column": "VisitDate", "val": visit['visit_date']},
            {
              "@column": "GSS_CustomerVisitConcept_ID",
              "val": visit['gss_customer_visit_concept_id']
            },
            {"@column": "AD_Client_ID", "val": visit['ad_client_id']},
            {"@column": "AD_Org_ID", "val": visit['ad_org_id']},
            {
              "@column": "C_BPartner_Location_ID",
              "val": visit['c_bpartner_location_id']
            },
          ]
        }
      },
  ...
  final recordCustomerVisitId = parsedJson['StandardResponse']['outputFields']
      ['outputField'][2]['@value'];
