...
import 'package:sales_force/presentation/screen/login/login_info.dart';
    ...
    if (await configFile.exists()) {
      try {
        ...
        if (content.isNotEmpty) {
          ...
          setState(() {
            isLoading =
                false; // Cuando todas las operaciones asincrónicas hayan terminado.
          });
        } else {
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(
                            bottom: 10), // Ajuste de la posición vertical
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.end,
                          children: [
                            Image.asset(
                              'lib/assets/Grupo san simon@3x.png',
                              width: 150,
                            ),
                          ],
                        ),
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: const InputDecoration(
                                    ...
                                    contentPadding: EdgeInsets.symmetric(
                                        vertical: 23.0,
                                        horizontal:
                                            20.0), // Ajusta el padding interno
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon: IconButton(
                                      icon: isPasswordVisible
                                          ? ImageIcon(
                                              const AssetImage(
                                                  'lib/assets/Ojos Activado@3x.png'),
                                              size: 24,
                                              color: colors.primary,
                                            )
                                          : const ImageIcon(
                                              AssetImage(
                                                  'lib/assets/Ojo Desactivado@3x.png'),
                                              size: 24,
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      style: ElevatedButton.styleFrom(
                                        ...
                                        backgroundColor: Color(
                                            0XFF00722D), // Color de fondo del botón
                                        shape: RoundedRectangleBorder(
                                          borderRadius: BorderRadius.circular(
                                              15.0), // Ajusta el radio de las esquinas
                                          side: const BorderSide(
                                            color: Colors
                                                .green, // Color del borde con opacidad
