...
import 'package:sales_force/config/ExtractData/extract_pos_properties_data.dart';
...
Future<void> syncGetPosProperties(posPropertiesData) async {
      ...
      print('Estas son las propiedades Pos $posPropertiesData');
      ...
      if (db != null) {
        ...
        for (Map<String, dynamic> posPropertieData in posPropertiesData) {
          ...
          print('propiedad pos doc action so ${posPropertieData}');
        dynamic objeto = {
              ...
              'doc_status_order_so': posPropertieData['doc_status_order_so'].toString(),
              'doc_status_order_po': posPropertieData['doc_status_order_po'],
              'c_doc_type_target_fr': posPropertieData['c_doc_type_target_fr'],
              'c_chargediscount1_id':posPropertieData['c_chargediscount1_id'],
              'c_chargediscount2_id':posPropertieData['c_chargediscount2_id'],
              'discount1': posPropertieData['discount1'],
              'discount2': posPropertieData['discount2']
          };
    ...
    if (db != null) {
      ...
      final List<Map<String, dynamic>> result = await db.rawQuery('''
        SELECT
          ...
          c_chargediscount1_id,
          c_chargediscount2_id,
          discount1,
          discount2
        FROM posproperties
        WHERE country_id > ?
