...
import 'package:sales_force/infrastructure/bank_accounts.dart';
import 'package:sales_force/infrastructure/models/ciiu.dart';
import 'package:sales_force/infrastructure/models/clients.dart';
import 'package:sales_force/infrastructure/models/impuestos.dart';
...
Future<void> syncCustomers( customersData,setState) async {
    ...
    print('esto es el customerData ${customerData['m_pricelist_id']}');
          Customer customer = Customer(
              ...
              mPriceListId: customerData['m_pricelist_id'].toString(),
              cPaymentTermId: customerData['c_payment_term_id'],
              deliveryRule: customerData['delivery_rule'],
              deliveryViaRule: customerData['delivery_via_rule'],
              invoiceRule: customerData['invoice_rule'],
              paymentRule: customerData['payment_rule'],
          );
      ...
      if (db != null) {
        ...
        for (Map<String, dynamic> productData in productsData) {
          ...
          Product product = Product(
            ...
            quantity: productData['quantity'] is int || productData['quantity'] is double ? productData['quantity']: 0,
